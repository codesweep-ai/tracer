...
# glossary table, or linked to the page that defines it. Take them from the
# vocabulary table in SPEC.md.
#
...
GLOSSARY = ["trajectory", "oracle", "golden", "shard", "fixture",
            "normalizer", "parity"]
