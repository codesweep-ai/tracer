...
export const CHECKS = [
  ...
  // F. size
  { id: "TF-26", name: "size.page", status: "must-change", target: { "large-session.bytes": "<=1500000", "codex-multi-agent-run.bytes": "<=380000", "subagent-run.bytes": "<=375000" }, note: "single-file page bytes with the CSS / JS split; budget per page, at (just above) today's size — the CSS is expected to shrink when Tailwind goes" },
