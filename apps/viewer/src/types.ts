...
export interface TraceMeta { source: string; sessionId: string; parentSessionId: string | null; parentEventIndex?: number | null; agentId?: string | null; label?: string; title?: string; autoTitle?: string; model?: string | null; cliVersion?: string | null; cwd?: string; sourceDir?: string; startedAt?: string; endedAt?: string }
...
export interface StripEvent { i: number; kind: EventKind; error: boolean; ts?: string; label?: string; size?: number; turnEnd?: boolean; subtask?: boolean; childSessionId?: string; redacted?: boolean; workMs?: number; activeMs?: number; idleMs?: number; approval?: "person" | "classifier" }
